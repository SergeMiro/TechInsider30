...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"js/api-telegram.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.fetchTopPostWithMostViews = void 0;
...
var fetchTopPostWithMostViews = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var options, response, posts, topPostWithMostViews;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          console.log(response.data); // Выводим ответ от API в консоль
          posts = response.data; // Предполагаем, что response.data содержит массив объектов с информацией о постах
          // Сортировка постов по убыванию просмотров (views)
          posts.sort(function (a, b) {
            return b.views - a.views;
          });
          topPostWithMostViews = posts[0]; // Первый элемент массива - пост с наибольшим количеством просмотров
          console.log('Пост с наибольшим количеством просмотров:');
          console.log(topPostWithMostViews);
          return _context.abrupt("return", topPostWithMostViews);
        case 15:
          _context.prev = 15;
          _context.t0 = _context["catch"](1);
          console.error('Произошла ошибка при получении данных:', _context.t0);
  ...
  return function fetchTopPostWithMostViews() {
    return _ref.apply(this, arguments);
  };
}();
exports.fetchTopPostWithMostViews = fetchTopPostWithMostViews;
},{"axios":"node_modules/axios/index.js"}],"js/index.js":[function(require,module,exports) {
"use strict";

var _apiTelegram = require("./api-telegram.js");
...
(0, _apiTelegram.fetchTopPostWithMostViews)().then(function (result) {
  displayResult(result);
}).catch(function (error) {
  console.error('Произошла ошибка:', error);
  displayResult(null);
});
},{"./api-telegram.js":"js/api-telegram.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
